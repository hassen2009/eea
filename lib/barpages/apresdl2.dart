...
class apresDl2 extends StatefulWidget {
  const apresDl2({super.key});

  @override
  State<apresDl2> createState() => _apresDl2State();
}

class _apresDl2State extends State<apresDl2> {
  String x = DateFormat("EEEE").format(DateTime.now());
  final CollectionReference _lundi = FirebaseFirestore.instance.collection("lundil2");
  ...
  final CollectionReference _dimanche = FirebaseFirestore.instance.collection("dimanchel2");
  @override
